var RayReflectState = (function (_super) {
    __extends(RayReflectState, _super);
    function RayReflectState() {
        _super.call(this);
        this.vec2 = p2.vec2;
        this.airIndex = 1;
        this.shapeIndex = 1.5;
    }
    var d = __define,c=RayReflectState,p=c.prototype;
    p.init = function () {
    ...
    p.refract = function (out, direction, normal, airIndex, shapeIndex) {
    ...
    return RayReflectState;
})(State);
egret.registerClass(RayReflectState,'RayReflectState');
//# sourceMappingURL=RayReflectState.js.map